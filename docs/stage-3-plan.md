...
**Статус:** **в работе** — фазы 0–3 готовы (зависимость, `internal/model`, provider contacts, контроль потерь); далее фаза 4 (конфликты 412 в UI)  
...
**Сделано:** 0, 1, 2, 3 (+ тесты по этим блокам). Дальше — 4 (конфликты 412 в UI), затем 5–6.

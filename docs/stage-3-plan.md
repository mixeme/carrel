...
**Статус:** **в работе** — фазы 0–7 готовы (зависимость, model, provider, потери, конфликты 412, список, карточка, фото); далее фаза 8 (кэш миниатюр / LRU) и 9–11 (import/export, печать)  
...
**Сделано:** 0, 1, 2, 3, 4, 5, 6, 7 (+ тесты по этим блокам). Дальше — 8 (кэш миниатюр), затем 9–11.

...
| **2.6 — довести экраны до кадров** | **2.6.A1–A4, B1–B6, C1–C7, D1–D4, E1–E4** | **☐ · полная сверка проведена (§7.9); библиотека первой, гейты (2.6.E) вместе с ней; §2.6.F — условие исполнимости, читать до первого шага; C1–C4 не брать без надзора** |

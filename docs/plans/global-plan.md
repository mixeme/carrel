...
| **2.6 — довести экраны до кадров** | **2.6.A1–A4, B1–B6, C1–C7, D1–D4, E1–E4** | **☐ · полная сверка проведена (§7.9); библиотека первой, гейты по списку экранов (2.6.E) — вместе с ней; счётчики в рейле в roadmap** |

...
**Статус:** **готово** — фазы 0–11 (зависимости, CalDAV provider, RRULE, агенда, CRUD/серия, конфликты, кэш, import/export `.ics`, печать, тесты); шлюз к этапу 5  
...
**Сделано:** 0–11 (весь объём этапа 4). VTODO/VJOURNAL и единый вид нескольких календарей — этап 5.

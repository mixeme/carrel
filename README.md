...
**Smaller gaps:** attachments on tasks; a per-collection line saying when it last changed on the server; showing an event's original time zone when it differs; three of the narrow-screen refinements.

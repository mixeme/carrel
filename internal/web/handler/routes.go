...
func (s *Server) routes(staticFS fs.FS) http.Handler {
	...
	app.HandleFunc("POST "+s.Path("/app/settings/account"), s.SettingsAccount)
	...
	app.HandleFunc("GET "+s.Path("/app/collections/new"), s.CollectionNew)
	app.HandleFunc("POST "+s.Path("/app/collections/new"), s.CollectionNew)
	app.HandleFunc("GET "+s.Path("/app/collections/rename"), s.CollectionRename)
	app.HandleFunc("POST "+s.Path("/app/collections/rename"), s.CollectionRename)
	app.HandleFunc("GET "+s.Path("/app/collections/delete"), s.CollectionDelete)
	app.HandleFunc("POST "+s.Path("/app/collections/delete"), s.CollectionDelete)
	...
	// The ⋯ menu's destination pickers on the merged view (2.6.D2).
	app.HandleFunc("GET "+s.Path("/app/contacts/import"), s.ContactsImportPicker)
	app.HandleFunc("GET "+s.Path("/app/contacts/export"), s.ContactsExportPicker)
	...
	app.HandleFunc("GET "+s.Path("/app/calendar/import"), s.CalendarImportPicker)
	app.HandleFunc("GET "+s.Path("/app/calendar/export"), s.CalendarExportPicker)
	...
	app.HandleFunc("GET "+s.Path("/app/notes/import"), s.NotesImportPicker)
	app.HandleFunc("GET "+s.Path("/app/notes/export"), s.NotesExportPicker)
	...
	app.HandleFunc("GET "+s.Path("/app/files/published"), s.FilesPublished)
	app.HandleFunc("GET "+s.Path("/t/{account}/{col}"), s.FileThumb)
